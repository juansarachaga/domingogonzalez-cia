  ...
  return (
    <section className="w-full bg-white py-16 ">
      <div className="max-w-7xl mx-auto px-6 lg:px-12 space-y-20">
        ...
        {/* --- BLOQUE 1 --- */}
        <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-10 p-6 md:p-10">
          {/* Texto */}
          <div className="flex flex-col space-y-4">
            <p className="text-[#AE0C21] font-['Hanken_Grotesk'] font-light text-[14px] tracking-[0.05em] leading-[100%] uppercase">
              #BOSQUEDETALA
            </p>
            <h2 className="text-[28px] md:text-[36px] font-semibold leading-[120%] text-gray-900">
              Conservación del Ambiente <br /> y Producción Sustentable
            </h2>
            <p className="text-[16px] font-normal text-gray-800 leading-[150%]">
